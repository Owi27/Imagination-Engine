...
namespace ImgnVulkan
{
	...
	vk::raii::CommandBuffer RenderGraph::BeginSingleCommand()
	{
	...
	void RenderGraph::EndSingleCommand(vk::raii::CommandBuffer& pCommandBuffer)
	{
		pCommandBuffer.end();
