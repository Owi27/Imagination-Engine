...
void VulkanRenderer::CreateFrameGraphNodes()
{
	...
	//				//position
	//				GvkHelper::create_buffer(_physicalDevice, _device, sizeof(vec3) * _geometryData.positions.size(), VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &vertexBuffers.buffers[0].GetVkBuffer(), &vertexBuffers.buffers[0].GetVkMemory());
	//				GvkHelper::write_to_buffer(_device, vertexBuffers.buffers[0].GetVkMemory(), _geometryData.positions.data(), sizeof(vec3) * _geometryData.positions.size());
	//				//normal
	//				GvkHelper::create_buffer(_physicalDevice, _device, sizeof(vec3) * _geometryData.normals.size(), VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &vertexBuffers.buffers[1].GetVkBuffer(), &vertexBuffers.buffers[1].GetVkMemory());
	//				GvkHelper::write_to_buffer(_device, vertexBuffers.buffers[1].GetVkMemory(), _geometryData.normals.data(), sizeof(vec3) * _geometryData.normals.size());
	//				//texcoord
	//				GvkHelper::create_buffer(_physicalDevice, _device, sizeof(vec2) * _geometryData.texCoords.size(), VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &vertexBuffers.buffers[2].GetVkBuffer(), &vertexBuffers.buffers[2].GetVkMemory());
	//				GvkHelper::write_to_buffer(_device, vertexBuffers.buffers[2].GetVkMemory(), _geometryData.texCoords.data(), sizeof(vec2) * _geometryData.texCoords.size());
	//				//tangent
	//				GvkHelper::create_buffer(_physicalDevice, _device, sizeof(vec4) * _geometryData.tangents.size(), VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &vertexBuffers.buffers[3].GetVkBuffer(), &vertexBuffers.buffers[3].GetVkMemory());
	//				GvkHelper::write_to_buffer(_device, vertexBuffers.buffers[3].GetVkMemory(), _geometryData.tangents.data(), sizeof(vec4) * _geometryData.tangents.size());
	//			}
	...
	//				GvkHelper::create_buffer(_physicalDevice, _device, sizeof(unsigned int) * _geometryData.indices.size(), VK_BUFFER_USAGE_INDEX_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &indexBuffer.buffers[0].GetVkBuffer(), &indexBuffer.buffers[0].GetVkMemory());
	//				GvkHelper::write_to_buffer(_device, indexBuffer.buffers[0].GetVkMemory(), _geometryData.indices.data(), sizeof(unsigned int) * _geometryData.indices.size());
	//			}
	...
	//				GvkHelper::create_buffer(_physicalDevice, _device, sizeof(UniformBufferOffscreen), VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &offscreenUniformBuffer.buffers[0].GetVkBuffer(), &offscreenUniformBuffer.buffers[0].GetVkMemory());
	//				GvkHelper::write_to_buffer(_device, offscreenUniformBuffer.buffers[0].GetVkMemory(), &data, sizeof(UniformBufferOffscreen));
	//			}
	...
	//				descriptorBufferInfo.buffer = offscreenUB.buffers[0].GetVkBuffer();
	...
	//			GvkHelper::write_to_buffer(_device, offscreenUB.buffers[0].GetVkMemory(), &data, sizeof(UniformBufferOffscreen));
	...
	//				GvkHelper::create_buffer(_physicalDevice, _device, sizeof(UniformBufferFinal), VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &compositionUB.buffers[0].GetVkBuffer(), &compositionUB.buffers[0].GetVkMemory());
	//				GvkHelper::write_to_buffer(_device, compositionUB.buffers[0].GetVkMemory(), &data, sizeof(UniformBufferFinal));
	//			}
	...
	//				VkDescriptorBufferInfo descriptorBufferInfo;
	//				descriptorBufferInfo.buffer = compositionUB.buffers[0].GetVkBuffer();
	//				descriptorBufferInfo.offset = 0;
