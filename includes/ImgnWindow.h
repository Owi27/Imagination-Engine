...
public:
	...
	/*Copy Constructor*/
	ImgnWindow(const ImgnWindow& pOther) = default;

	/*Copy Assignment Operator*/
	ImgnWindow& operator=(const ImgnWindow& pOther) = default;

	/*Move Constructor*/
	ImgnWindow(ImgnWindow&& pOther) noexcept = default;

	/*Move Assignment Operator*/
	ImgnWindow& operator=(ImgnWindow&& pOther) noexcept = default;
};